...
class CreditsControllerTest < ActionController::TestCase
  ...
  test "post create" do
    ...
    assert_difference ['Credit.count', 'AccountTran.count', 'Tran.count'] do
      post :create, params: { customer_id: customers(:one), credit: {
  ...
  test "get edit" do
    ...
    get :edit, params: { customer_id: customers(:one), id: credits(:one) }
    assert_response :success
    assert_not_nil assigns(:credit)
  end
  ...
  test "get edit credit must belong to user" do
    sign_in users(:one), scope: :user
    get :edit, params: { customer_id: customers(:one), id: credits(:two) }
    assert_redirected_to root_path
  end
  ...
  test "put update" do
    ...
    put :update, params: { customer_id: customers(:one), id: credits(:one), credit: {
  ...
  test "put update requires logged in user" do
    put :update, params: { customer_id: customers(:one), id: credits(:one) }
    assert_redirected_to new_user_session_path
  end
  ...
  test "put update requires credit to belong to user" do
    sign_in users(:one), scope: :user
    put :update, params: { customer_id: customers(:one), id: credits(:two) }
    assert_redirected_to root_path
  end
  ...
  test "show should redirect to edit path" do
    ...
    get :show, params: { customer_id: customers(:one), id: credits(:one) }
  ...
  test "delete destroy" do
    ...
    assert_difference ['Credit.count', 'Tran.count', 'AccountTran.count'], -1 do
      delete :destroy, params: { customer_id: customers(:one), id: credits(:one) }
    end
  end
  ...
  test "delete requires credit to belong to user" do
    ...
    assert_difference ['Credit.count', 'Tran.count', 'AccountTran.count'], 0 do
      delete :destroy, params: { customer_id: customers(:one), id: credits(:two) }
    end
