...
class RecurringTransControllerTest < ActionController::TestCase
  ...
  test "post create should work for checks" do
    ...
    assert_difference "RecurringTran.count" do
      post :create, xhr: true, params: { id: checks(:one).id, type: "Check", due_date: "5" }
    end
  end
  ...
  test "get edit" do
    sign_in users(:one), scope: :user
    get :edit, xhr: true, params: { id: recurring_trans(:one) }
    assert_response :success
  ...
  test "put update" do
    ...
    put :update, xhr: true, params: { id: recurring_trans(:one), recurring_tran: {
      due_date: "3",
    }}
  ...
  test "put update requires tran to belong to user" do
    ...
    put :update, params: { id: recurring_trans(:one), recurring_tran: {
      due_date: "3",
    }}
  ...
  test "delete destroy" do
    ...
    assert_difference 'RecurringTran.count', -1 do
      delete :destroy, xhr: true, params: { id: recurring_trans(:one) }
    end
  ...
  test "delete destroy requires same tran user" do
    ...
    assert_difference 'RecurringTran.count', 0 do
      delete :destroy, params: { id: recurring_trans(:one) }
    end
